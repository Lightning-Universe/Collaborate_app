  ...
  return (
    <React.Fragment>
      <Container disableGutters sx={{ display: 'flex', flexDirection: 'column', width: '50%' }}>
        ...
        <Link rel="noopener noreferrer" target="_blank" sx={{ ml: 1, letterSpacing: 1 }} href="https://github.com/Lightning-AI/collaborate#troubleshooting">Troubleshooting Guide</Link>
